...
function setup() {
  ...
  if (loadedGroups) {
    ...
    console.error('Failed to load groups from local storage');
    return;
  }
  
  chat = groups[window.groupName];
  createCanvas(windowWidth, windowHeight);
  console.log(chat);
  console.log(groups[window.groupName]);
  console.log(chat.renderedMessages);
  messages = groups[window.groupName].renderedMessages;
  // calculateFinalSizes();
  // textFont('Arial');
  ...
  //   let groupName = window.groupName;
